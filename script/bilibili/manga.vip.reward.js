...
!(async () => {
  if (!BILI_MANGA_COOKIE) {
    ...
    await getVipReward('【福利券】', 'https://manga.bilibili.com/twirp/user.v1.User/GetVipReward');
    await getVipReward('【商城券】', 'https://manga.bilibili.com/twirp/activity.v1.Activity/TakeShopCoupon');
  }
